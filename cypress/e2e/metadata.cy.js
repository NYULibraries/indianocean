describe("Page Titles", () => {
	it("should have correct title on home page", () => {
		cy.visit("/");
		cy.title().should("eq", "Monographs, Maps, Postcards, Prints");
	});

	it("should have correct title on about page", () => {
		cy.visit("/about");
		cy.title().should("eq", "Indian Ocean Digital Collection - About");
	});

	it("should have correct title on search page", () => {
		cy.visit("/search");
		cy.title().should("eq", "Indian Ocean Digital Collection - Browse");
	});
